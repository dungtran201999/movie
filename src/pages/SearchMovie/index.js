    ...
    return (
        <div className="relative">
            <div className="text-right mb-10 mt-5">
                <input 
                    type="text" 
                    className="border-b border-[#fff] py-2 px-3 w-full md:w-[58%] bg-transparent text-white outline-none" 
                    placeholder="Search Movie Title..." 
                    value={searchValue}
                    onChange={handleSearchOnChange}
                    />
            </div>
            <div className={`${showDropdownMenu ? 'translate-y-0 visible opacity-100 transition-all duration-[1000ms]': 'translate-y-5 invisible opacity-0'}  absolute w-full md:w-[58%] top-full right-0 bg-[#000000c2] pt-1`}>
